...
Create table Benefits(bName VARCHAR(15) not null,bPrice NUMBER,PRIMARY KEY(bName)); 
...
tBookTimes NUMBER not null,CategoryName VARCHAR2(15) not null,PRIMARY KEY(tNo),FOREIGN KEY(CATEGORYNAME) REFERENCES CATEGORY(NAME));
...
insert into Clients(cNo,cAT,cLastName,cFirstName,cRegDate)
VALUES(103,'K919191','IWANNIDHS','GIANNHS',TO_DATE('09/08/2020','DD/MM/YYYY'));
insert into Clients(cNo,cAT,cLastName,cFirstName,cRegDate)
...
insert into Booking(cNo,tNo,cInDate,cOutDate)
VALUES(102,20,TO_DATE('19/06/2020 08:00','DD/MM/YYYY HH:MI'),TO_DATE('20/06/2020 02:00','DD/MM/YYYY HH:MI'));
insert into Booking(cNo,tNo,cInDate,cOutDate)
VALUES(102,24,TO_DATE('19/06/2020 08:00','DD/MM/YYYY HH:MI'),TO_DATE('20/06/2020 02:00','DD/MM/YYYY HH:MI'));
