...
VALUES(100,'M969696','GIORGIOY','GIORGOS',TO_DATE('03/12/2019','DD/MM/YYYY'));
insert into Clients(cNo,cAT,cLastName,cFirstName,cRegDate)
VALUES(101,'K959595','DHMHTRIOY','DHMHTRHS',TO_DATE('06/03/2019','DD/MM/YYYY'));
insert into Clients(cNo,cAT,cLastName,cFirstName,cRegDate)
VALUES(102,'L989898','PAPADOPOYLOY','MARIA',TO_DATE('22/01/2020','DD/MM/YYYY'));
insert into Clients(cNo,cAT,cLastName,cFirstName,cRegDate)
VALUES(103,'M919191','IWANNIDHS','GIANNHS',TO_DATE('28/08/2020','DD/MM/YYYY'));
insert into Clients(cNo,cAT,cLastName,cFirstName,cRegDate)
VALUES(104,'N939393','IWANNIDOY','GEORGIA',TO_DATE('28/08/2020','DD/MM/YYYY'));
...
VALUES(100,20,TO_DATE('18/12/2019 09:30','DD/MM/YYYY HH:MI'),TO_DATE('18/12/2019 11:53','DD/MM/YYYY HH:MI'));
insert into Booking(cNo,tNo,cInDate,cOutDate)
VALUES(101,21,TO_DATE('19/06/2019 08:00','DD/MM/YYYY HH:MI'),TO_DATE('19/06/2019 11:00','DD/MM/YYYY HH:MI'));
insert into Booking(cNo,tNo,cInDate,cOutDate)
...
insert into Booking(cNo,tNo,cInDate,cOutDate)
VALUES(104,23,TO_DATE('24/09/2020 09:45','DD/MM/YYYY HH:MI'),TO_DATE('25/09/2020 12:45','DD/MM/YYYY HH:MI'));
